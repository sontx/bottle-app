...
/**
 * Src: https://github.com/oguzbilgener/CircularFloatingActionMenu/blob/master/samples/src/main/java/com/oguzdev/circularfloatingactionmenu/samples/SlideInAnimationHandler.java
 */
public class SlideInAnimationHandler extends MenuAnimationHandler {
     ...
     */
    private static final int LAG_BETWEEN_ITEMS = 100;

    private static final int DIST_Y = 1000;
